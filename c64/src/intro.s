...
loop:
        lda sync_raster_irq2
        beq loop

        dec sync_raster_irq2
...
.proc init_sprite
        ...
        ldx #(SPRITES_POINTER + 3)      ; sprite pointer to PAL
        ...
        ldx #(SPRITES_POINTER + 2)      ; otherwise it is NTSC
        bne @end

@ntscold:
        ldx #(SPRITES_POINTER + 0)      ; NTSC old
        bne @end
@paln:
        ldx #(SPRITES_POINTER + 1)      ; PAL-N (Drean)
@end:
